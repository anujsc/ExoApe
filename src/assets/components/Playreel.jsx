...
function Playreel() {
  ...
  return (
    <div
      ref={parent}
      className=" relative w-full h-screen mt-[19vh] bg-black opacity-90"
    >
      vi
      <div
        ref={video}
        className=" w-36 md:w-96 aspect-video absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 "
      >
        <video
          muted
          loop
          autoPlay
          className=" opacity-70 w-full h-full scale-[1.1] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 "
      ...
      <div className="overlay absolute w-full h-full py-20 text-white flex flex-col justify-between ">
        ...
        <h1 className=" w-full flex justify-center gap-32 md:gap-[80vh] items-center ">
          <div
            ref={play}
            className=" text-4xl md:text-9xl md:font-medium font-light"
          >
            Play
          </div>
          <div
